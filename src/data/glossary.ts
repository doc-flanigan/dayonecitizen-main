...
export const GLOSSARY: GlossaryTerm[] = [
  ...
  // ─────────────── Ships — Anvil Aerospace ───────────────
  {
    ...
    category: 'Ships',
    definition:
      "Anvil's smallest fighter, fastest combat ship. A nimble dogfighter that rewards hit-and-run tactics — just don't take too many hits. One of the most affordable dedicated fighters.",
  ...
  },
  {
    ...
    category: 'Ships',
    definition:
      "Origin's mid-range luxury line. The 300i is a flexible multi-role; the 315p adds tractor beam and upgraded communications; the 325a upgrades the weapons; the 350r is a dedicated racer. All look extraordinary.",
  ...
  },
  {
    ...
    category: 'Ships',
    definition:
      "Origin luxury runabout designed to live inside the 890 Jump and handle short hops. The space equivalent of a personal speedboat stored on a superyacht.",
    lastVerified: '2026-09-14',
  },
  {
